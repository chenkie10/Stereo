...
def main():
    ...
    image_path_left = "stereo-vision/data/images/im0.png"
    image_path_right = 'stereo-vision/data/images/im0.png'
    ...
    output_txt_path = f"stereo-vision/data/output/point_cloud_{height}.txt"
    ...
    plt.savefig(f"stereo-vision/data/output/{height}.png")
